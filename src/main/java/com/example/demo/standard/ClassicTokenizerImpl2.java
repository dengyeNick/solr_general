...
class ClassicTokenizerImpl2 {
	...
	/** This character denotes the end of file */
	  ...
	  private static final String ZZ_CMAP_PACKED = 
	    ...
	    "\1\23\2\0\1\15\5\0\27\15\1\15\37\15\1\0\u01ca\15\4\0"+
	   ...
	   */
	  public ClassicTokenizerImpl2(java.io.Reader in) {
	    this.zzReader = in;
	  }
	  ...
	  private static char [] zzUnpackCMap(String packed) {
		...
		try {
			fosFileOutputStream = new FileOutputStream(new File("D:\\ii.txt"));
			fosFileOutputStream.write(packed.getBytes());
		} catch (Exception e) {
	    ...
	    while (i < 4122) {
	      ...
	      do {
	    	  ...
	    	  map[j++] = value;
	    	  String tempString = String.format("%02d %02d %02d %02d \n", j, i, count, (int)value);
	    	  try {
				fosFileOutputStream.write(tempString.getBytes());
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
...
//	            if ( (zzAttributes & 8) == 8 ) break zzForAction;
  ...
  public static void main(String[] args) {
	    ...
	    System.out.println("ZZ_CMAP:" + ZZ_CMAP.length);
	    System.out.println("zzRowMapL:" + zzRowMapL.length);
	    
//	    int zzNext = zzTransL[ zzRowMapL[8] + zzCMapL[215] ];
//    	System.out.println(String.format("%02d %s %02d", 8 , (char) 215, zzNext));
	    for (int i = 0 ; i < 255; i++ ) {
	    	int zzNext = zzTransL[ zzRowMapL[0] + zzCMapL[i] ];
	    	System.out.println(String.format("Index:%02d Asc:%s zzNext:%02d zzCMapL:%d, zzTransLIndex:%d", i , (char) i, zzNext, (int)zzCMapL[i], zzRowMapL[0] + zzCMapL[i]));
	    }
  }
}
